class OppleLightAccessory {
  ...
  getServices() {
    ...
    lightbulbService
      ...
      .on('get', callback => this.device.getPower().then(value => callback(null, value)))
      .on('set', (value, callback) => this.device.setPower(value).then(value => callback(), callback));

    lightbulbService
      .getCharacteristic(Characteristic.Brightness)
      .on('get', callback => this.device.getBrightness().then(value => callback(null, value)))
    ...
    lightbulbService
      ...
      .on('get', callback => this.device.getColorTemperature().then(value => callback(null, value)))
    ...
    informationService
      ...
      .setCharacteristic(Characteristic.FirmwareRevision, this.device.version.toString().split('').join('.'));
